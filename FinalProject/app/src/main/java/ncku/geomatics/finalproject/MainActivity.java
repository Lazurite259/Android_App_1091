...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (c.getCount() == 0) {
            ...
            addData("國立成功大學博物館", R.drawable.museum, "一個踏溯台南去過後，就不會再踏進去的地方。", 22.9967249, 120.2196, "false");
            addData("國立成功大學測量與空間資訊學系", R.drawable.geomatics, "全成大校園的中心，據傳也是全宇宙中心的所在。", 22.998669, 120.219832, "false");
            addData("國立成功大學材料科學及工程學系新館", R.drawable.mse, "不知道什麼時候土木也可以來找我們蓋系館。", 22.9984536, 120.221855, "false");
            addData("格致堂", R.drawable.ncku_g, "舊時代的考場，不知道那時候有沒有人平差是在這裡被當掉的。", 22.9970924, 120.219597, "false");
            addData("國立成功大學工程科學系", R.drawable.es, "離郵局ATM兩分鐘，麥當勞跟小七只要三分鐘的地方，當初選系館位置的大哥一定是天才。", 22.9965916, 120.221601, "false");
            addData("國立成功大學環境工程學系", R.drawable.eve, "一句話惹怒環工系：你長大是不是會去挖石油？", 23.0000087, 120.220807, "false");
        }
    }
